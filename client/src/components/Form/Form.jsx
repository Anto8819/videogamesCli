...
export function Form() {
    ...
    const genres = useSelector((state)=>state.genres) //need the genres to display in the multiselector
...
//-------------------Function to handle the Multiselector-------------
...
//-------------------post request to backend with local state as body-------------
